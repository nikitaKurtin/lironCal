...
public class HttpRequest {
    ...
    /**
     * Pinning given Certificate to current Connection
     * @param ca Certificate Timeout in milliseconds
     * @return HttpRequest this instance -> for chaining method @see line 22
     * */
    //TODO - Must to be tested
    public HttpRequest withCAPin(Certificate ca) throws KeyStoreException, CertificateException, NoSuchAlgorithmException, IOException, KeyManagementException {
